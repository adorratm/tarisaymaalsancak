...
class Reference_categories extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $viewData->items = $this->reference_category_model->get_all(["lang" => $this->session->userdata("activeLang")]);
        $this->load->view("{$viewData->viewFolder}/{$viewData->subViewFolder}/index", $viewData);
    }
    public function datatable()
    {
        $items = $this->reference_category_model->getRows(["lang" => $this->session->userdata("activeLang")], $_POST);
        $data = [];
        ...
        $output = [
            ...
            "recordsTotal" => $this->reference_category_model->rowCount(["lang" => $this->session->userdata("activeLang")]),
            "recordsFiltered" => $this->reference_category_model->countFiltered(["lang" => $this->session->userdata("activeLang")], (!empty($_POST) ? $_POST : [])),
            "data" => $data,
        ];
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"]) :
            ...
            $getRank = $this->reference_category_model->rowCount(["lang" => $this->session->userdata("activeLang")]);
    ...
    public function update_form($id)
    {
        ...
        $viewData->item = $this->reference_category_model->get(["id" => $id,"lang" => $this->session->userdata("activeLang")]);
        $viewData->settings = $this->general_model->get_all("settings", null, null, ["isActive" => 1,"lang" => $this->session->userdata("activeLang")]);
        $this->load->view("{$viewData->viewFolder}/{$viewData->subViewFolder}/content", $viewData);
    }
    public function update($id)
    {
        ...
        if (checkEmpty($data)["error"]) :
            ...
            $reference_category = $this->reference_category_model->get(["id" => $id,"lang" => $this->session->userdata("activeLang")]);
    ...
    public function delete($id)
    {
        ...
        if (!empty($reference_category)) :
            ...
            if ($delete) :
                 ...
                 */
                $references = $this->reference_model->get_all(["lang" => $this->session->userdata("activeLang")]);
                if (!empty($references)) :
