...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $likes = [];
        $wheres["p.isActive"] = 1;
        $joins = ["products_w_categories pwc" => ["p.id = pwc.product_id", "left"], "product_variation_groups pvg" => ["p.id = pvg.product_id", "left"], "product_categories pc" => ["pc.id=pwc.category_id", "left"]];
