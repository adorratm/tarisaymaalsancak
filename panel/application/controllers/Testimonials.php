...
class Testimonials extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $viewData->items = $this->testimonial_model->get_all(["lang" => $this->session->userdata("activeLang")], "rank ASC");
        $this->load->view("{$viewData->viewFolder}/{$viewData->subViewFolder}/index", $viewData);
    }
    public function datatable()
    {
        $items = $this->testimonial_model->getRows(["lang" => $this->session->userdata("activeLang")], $_POST);
        $data = [];
        ...
        $output = [
            ...
            "recordsTotal" => $this->testimonial_model->rowCount(["lang" => $this->session->userdata("activeLang")]),
            "recordsFiltered" => $this->testimonial_model->countFiltered(["lang" => $this->session->userdata("activeLang")], (!empty($_POST) ? $_POST : [])),
            "data" => $data,
        ];
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"] && checkEmpty($data)["key"] !== "name" && checkEmpty($data)["key"] !== "surname" && checkEmpty($data)["key"] !== "company_name" && checkEmpty($data)["key"] !== "img_url") :
            ...
            $getRank = $this->testimonial_model->rowCount(["lang" => $this->session->userdata("activeLang")]);
    ...
    public function update_form($id)
    {
        ...
        $viewData->item = $this->testimonial_model->get(["id" => $id, "lang" => $this->session->userdata("activeLang")]);
        $viewData->settings = $this->general_model->get_all("settings", null, null, ["isActive" => 1, "lang" => $this->session->userdata("activeLang")]);
        $this->load->view("{$viewData->viewFolder}/{$viewData->subViewFolder}/content", $viewData);
    }
    public function update($id)
    {
        ...
        if (checkEmpty($data)["error"] && checkEmpty($data)["key"] !== "name" && checkEmpty($data)["key"] !== "surname" && checkEmpty($data)["key"] !== "company_name" && checkEmpty($data)["key"] !== "img_url") :
            ...
            $testimonial = $this->testimonial_model->get(["id" => $id, "lang" => $this->session->userdata("activeLang")]);
