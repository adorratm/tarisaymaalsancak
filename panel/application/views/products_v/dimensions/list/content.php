...
<div class="container-fluid mt-xl-50 mt-lg-30 mt-15 bg-white p-3">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h4 class="mb-3">
                "<b><?= stripslashes($item->title); ?></b>" kaydına ait ölçüler
...
<script>
    $(document).ready(function() {
        $(document).on("click", ".createProductDimensionsBtn", function(e) {
            ...
            createModal("#productDimensionsModal", "Yeni Ölçü Ekle", "Yeni Ölçü Ekle", 600, true, "20px", 0, "#e20e17", "#fff", 1040, function() {
        ...
        $(document).on("click", ".updateProductDimensionsBtn", function(e) {
            ...
            $('#productDimensionsModal').iziModal('destroy');
            let url = $(this).data("url");
            createModal("#productDimensionsModal", "Ölçü Düzenle", "Ölçü Düzenle", 600, true, "20px", 0, "#e20e17", "#fff", 1040, function() {
                $.post(url, {}, function(response) {
                    $("#productDimensionsModal .iziModal-content").html(response);
                    TinyMCEInit();
                    flatPickrInit();
