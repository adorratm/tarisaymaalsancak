...
<body>
    <div class="container bg-light p-3">
        ...
        <div class="d-flex flex-wrap text-center align-middle align-items-center justify-content-center w-100 mb-3">
            <img src="<?= get_picture("settings_v", $settings->logo) ?>" class="img-fluid text-center align-middle align-items-center justify-content-center mx-auto px-auto mb-3" style="max-width: 250px;max-height:250px;">
        </div>
        <p><?= $message ?></p>
        <br>
        <h3 class="text-center justify-content-center align-items-center align-middle mb-3"><?= lang("deliveryAndBillngAddress") ?></h3>
                            ...
                            <?php if (!empty($product)) : ?>
                                <tr>
                                    <td class='text-center align-middle justify-content-center mx-auto px-auto'>
                                        <img class='img-fluid' src='<?= get_picture("products_v", $product->img_url) ?>' style='max-width:150px;max-height:150px;'>
                                    </td>
