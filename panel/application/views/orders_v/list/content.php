	...
	<div class="row">
		...
		<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
			<div class="alert alert-info" role="alert">
				...
				<p>- Gelen Siparişlerin Durumu "Ödeme Bekleniyor." İse Kullanıcı Her Ödeme Sayfasına Gittiğinde Eski Oluşan Sipariş Silinir, Yeni Sipariş Oluşur.</p>
				<p>- "Ödeme Bekleniyor." Dışındaki Bütün Sipariş Durumlarında Kargo Bilgisi Girilebilmektedir. Satın Alınan Siparişe Kargo Bilgisi Girebilmek İçin Durumunu Güncellemelisiniz.</p>
				<p>- Sipariş Durumu ve Kargo Durumu Her Değiştiğinde Kullanıcıya Bildirim Amaçlı Email Gider. Emailin Gönderilmesini Beklemeli ve Başarılı Mesajını Almalısınız. Email Adresi Hatalı Olan Kullanıcılara Email Gönderilirken Hata Oluşabilir.</p>
				<p>- Oluşan Her Siparişin Ödemesi Alındıysa Kargo Takip Numarası Girilmelidir.</p>
				<p>- Kullanıcılar Siparişinin Durumunu İsterlerse E-Mail Adresinden İsterlerse Hesabım -> Siparişlerim Bölümünden Takip Edebilirler.</p>
				<p>- Havale İle Ödeme Yöntemi Seçilip Sipariş Geçildiğinde Siparişin Durumu "Ödeme Bekleniyor." Olarak Kalır. Banka Havalesinin Ödemesinin Geçtiğini Teyit Edip Siparişin Durumunu "Ödeme Alındı." Şeklinde Güncellemeniz Gerekmektedir.</p>
				<p>- PAYTR ödeme altyapısında "İptal Edildi." durumundaki siparişlerin Kredi Kartı / Banka Kartı ödemeleri kullanıcıya geri iade edilmektedir. İade takibini PAYTR panelinizden kontrol edebilirsiniz.</p>
				<hr>
				<p class="mb-0">Siparişin Hazırlanma Kargo, Teslim, İptal, Tamamlanma vb. Aşamaları İçin Durum Bilgisini Güncellemeyi Unutmayın.</p>
			</div>
