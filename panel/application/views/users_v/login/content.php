...
<header class="d-flex justify-content-between align-items-center">
    ...
    <div class="btn-group btn-group-sm">
        <a href="https://github.com/adorratm" class="btn btn-sm btn-outline-secondary rounded-0">Powered By</a>
        <a href="https://github.com/adorratm" class="btn btn-sm btn-outline-secondary rounded-0">Adorra™</a>
    </div>
</header>
