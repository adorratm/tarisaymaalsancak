...
<div class="tab-pane fade" id="social-media" role="tabpanel" aria-labelledby="social-media-tab">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input class="form-control form-control-sm rounded-0" placeholder="App Store Uygulama Linki" name="appstore" value="<?= $item->appstore ?>">
        </div>
        <div class="form-group col-md-6">
            <label>Play Store Uygulama Linki</label>
            <input class="form-control form-control-sm rounded-0" placeholder="Play Store Uygulama Linki" name="playstore" value="<?= $item->playstore ?>">
        </div>
    </div>
</div>