...
<div class="container-fluid mt-xl-50 mt-lg-30 mt-15 bg-white p-3">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h4 class="mb-3">
                Ayar Listesi
                <a href="javascript:void(0)" data-url="<?= base_url("settings/new_form"); ?>" class="d-none float-right btn btn-sm btn-outline-primary rounded-0 btn-sm createSettingsBtn"><i class="fa fa-plus"></i>Yeni Ekle</a>
            </h4>
            <hr>
        </div><!-- END column -->
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
