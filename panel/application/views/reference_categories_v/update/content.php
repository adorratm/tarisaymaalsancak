...
<form id="updateReferenceCategory" onsubmit="return false" action="" method="post">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="form-group">
                ...
                <select name="showMap" id="showMap" class="form-control form-control-sm rounded-0">
                    <option <?= !$item->showMap ? "selected" : null ?> value="0">Gösterme</option>
                    <option <?= $item->showMap ? "selected" : null ?> value="1">Göster</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <button role="button" data-url="<?= base_url("reference_categories/update/{$item->id}"); ?>" class="btn btn-sm btn-outline-primary rounded-0 btnUpdate">Güncelle</button>
