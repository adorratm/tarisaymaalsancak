    ...
    <div class="row d-none">
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <label>Ad</label>
                <input disabled class="form-control form-control-sm rounded-0" placeholder="Ad Soyad" name="name" required>
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <label>Soyad</label>
                <input disabled class="form-control form-control-sm rounded-0" placeholder="Soyad" name="surname" required>
            </div>
        </div>
    </div>
    <div class="row">
