...
class Menu_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'position', 'top_id', 'url','lang', 'isActive', 'createdAt', 'updatedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'position', 'top_id', 'url','lang', 'isActive', 'createdAt', 'updatedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
