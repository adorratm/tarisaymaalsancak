...
class Product_category_part_model extends CI_Model
{
    public $tableName = "product_category_parts";
    public function __construct()
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'price', 'quantity', 'lang', 'isActive', 'createdAt', 'updatedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'price', 'quantity', 'lang', 'isActive', 'createdAt', 'updatedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
