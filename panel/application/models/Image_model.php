...
class Image_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->column_order = ['images.rank', 'images.id', 'images.id', 'images.url', 'images.url', 'images.lang', 'images.isActive', 'images.createdAt', 'images.updatedAt', 'images.sharedAt'];
        // Set searchable column fields
        $this->column_search = ['images.rank', 'images.id', 'images.id', 'images.url', 'images.url', 'images.lang', 'images.isActive', 'images.createdAt', 'images.updatedAt', 'images.sharedAt'];
        // Set default order
        $this->order = ['images.rank' => 'ASC'];
    }
