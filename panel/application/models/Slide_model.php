...
class Slide_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'description','lang', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'description','lang', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
