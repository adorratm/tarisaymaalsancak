...
class Bank_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'content','lang',  'isActive', 'createdAt', 'updatedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'content','lang', 'isActive', 'createdAt', 'updatedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
