...
class Homeitem_model extends CI_Model
{
    public $tableName = "home_items";
    public function __construct()
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'content','lang', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'content','lang', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
