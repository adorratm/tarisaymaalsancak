...
class Email_settings_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'user_name', 'user', 'host', 'lang', 'createdAt', 'updatedAt', 'isActive'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'user_name', 'user', 'host', 'lang', 'createdAt', 'updatedAt', 'isActive'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
