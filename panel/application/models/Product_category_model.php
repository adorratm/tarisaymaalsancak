...
class Product_category_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['product_categories.rank', 'product_categories.id', 'product_categories.id', 'product_categories.title', 'pc.title', 'product_categories.lang', 'product_categories.isActive', 'product_categories.createdAt', 'product_categories.updatedAt'];
