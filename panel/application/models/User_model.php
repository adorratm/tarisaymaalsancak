...
class User_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'name', 'surname', 'email', 'isActive', 'createdAt', 'updatedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'name', 'surname', 'email', 'isActive', 'createdAt', 'updatedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
