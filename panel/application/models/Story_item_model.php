...
class Story_item_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->column_order = ['story_items.rank', 'story_items.id', 'story_items.id', 'story_items.url', 'story_items.url', 'story_items.lang', 'story_items.isActive', 'story_items.createdAt', 'story_items.updatedAt', 'story_items.sharedAt'];
        // Set searchable column fields
        $this->column_search = ['story_items.rank', 'story_items.id', 'story_items.id', 'story_items.url', 'story_items.url', 'story_items.lang', 'story_items.isActive', 'story_items.createdAt', 'story_items.updatedAt', 'story_items.sharedAt'];
        // Set default order
        $this->order = ['story_items.rank' => 'ASC'];
    }
