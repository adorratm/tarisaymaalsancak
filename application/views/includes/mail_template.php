...
<body>
    <div class="container bg-light p-3">
        <h2 class="p-0 text-center justify-content-center align-items-center align-middle mb-3"><?= $subject; ?></h2>
        <div class="d-flex flex-wrap text-center align-middle align-items-center justify-content-center w-100 mb-3">
            <img loading="lazy" src="<?= get_picture("settings_v", $settings->logo) ?>" class="img-fluid text-center align-middle align-items-center justify-content-center mx-auto px-auto mb-3" style="max-width: 250px;max-height:250px;" width="250" height="250">
        </div>
        <p><?= $message ?></p>
        <br>
        <h3 class="text-center justify-content-center align-items-center align-middle mb-3"><?= lang("deliveryAndBillingAddress") ?></h3>
                ...
                <table class="table table-bordered table-striped table-hover w-100" width="100%" border="1">
                            ...
                            <?php if (!empty($product)) : ?>
                                <tr>
                                    <td class='text-center align-middle justify-content-center mx-auto px-auto'>
                                        <img loading="lazy" class='img-fluid' src='<?= get_picture("products_v", $product->img_url) ?>' style='max-width:150px;max-height:150px;' width="150" height="150">
                                    </td>
                                    <td class='text-center align-middle justify-content-center mx-auto px-auto'><?= stripslashes($cart_value["name"]) ?>
                    ...
                    <tfoot>
                        ...
                        <?php if ((float)$order_data["shipping"] > 0) : ?>
                            <tr>
                                <td colspan="5" class="text-right"><?= lang("shipping") ?> : <span class="float-right"> <?= $order_data["shipping"] ?><?= $symbol ?></span></td>
                            </tr>
                        <?php endif ?>
                        <tr>
